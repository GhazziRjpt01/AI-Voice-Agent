...
React frontend + Node.js backend. The OpenAI API key stays on the server. The browser sends microphone audio over WebRTC; OpenAI Realtime replies with live voice.
